...
function sendEmail(e) {
	...
	emailjs.sendForm('service_dlegykx', 'template_nvnsxfg', e.target, 'user_YFMjXV8WXGrJU77bv9AS3')
	.then((result) => {
		          ...
		          <form className="contact-form-wrap">
		            <div className="row">
		              ...
		              <div className="col-12">
		                <div className="single-input-wrap input-group">
		                  <textarea className="form-control" name="message" rows={4} name="message" placeholder="Message" defaultValue={""} />
		                  <div className="input-group-prepend">
