     ...
     <section className="blog-area pd-top-90 pd-bottom-70 bg-sky-blue">
		  <div className="container">
		    ...
		    <div className="row justify-content-center go-top">
				{blogs.map(blog => (
					<React.Fragment>
		      <div key={blog.id_blog} className="col-lg-4 col-md-6">
		        <div className="single-blog-wrap">
		          ...
		          <div className="blog-details">
		            <div className="meta">
		              ...
		              <span><i className="far fa-user" aria-hidden="true" />BY ADMIN</span>
		            </div>
		            <h5><a href={"https://sbsp-penyengatolak.store/#/blogDetails/"+blog.id_blog}>{blog.judul_blog}</a></h5>
		          </div>
		        </div>
		      </div>
			  </React.Fragment>
